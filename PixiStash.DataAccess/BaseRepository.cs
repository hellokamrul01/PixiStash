...
namespace PixiStash.DataAccess
{
        ...
        where TEntity : class
    {
        ...
        public virtual void Edit(TEntity entityToEdit)
        {
            ...
            //{
            //    // The entity is already being tracked, so detach it
            //    _dbContext.Entry(entityToEdit).State = EntityState.Detached;
            //}
        ...
        public virtual async Task<int> GetCountAsync(Expression<Func<TEntity, bool>> filter = null)
        {
            ...
            if (filter != null)
            {
                count = await query.Where(filter).CountAsync();
            }
            else
        ...
        public virtual IList<TEntity> GetDynamic(Expression<Func<TEntity, bool>> filter = null,
            string orderBy = null, Func<IQueryable<TEntity>,
        ...
        public virtual async Task<IList<TEntity>> GetDynamicAsync(Expression<Func<TEntity, bool>> filter = null,
            string orderBy = null,
            Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include = null,
            bool isTrackingOff = false)
        {
